...
export function Settings() {
  ...
  // 仅保留 OpenAI 配置，并精简为只有 Key 输入框
  const openAIConfigComponent = (
    <>
      {/* 移除了接口地址输入框，强制使用环境变量配置的地址 */}
      <ListItem
        title="Key" // 强制显示为 Key
        subTitle="在此输入购买的密钥 (sk-...)" // 强制显示副标题
      >
        <PasswordInput
    ...
    <ErrorBoundary>
      ...
      <div className={styles["settings"]}>
        ...
        <List id={SlotID.CustomModel}>
          {/* 移除了 saasStartComponent 广告 */}
          {/* 移除了 accessCodeComponent 访问密码框 */}

          {!accessStore.hideUserApiKey && (
            <>
              {/* 移除了 useCustomConfigComponent 自定义接口开关 */}
              {/* 移除了 Provider 选择框，强制使用 OpenAI 组件 */}
              
              {openAIConfigComponent}
              
              {/* 移除了其他所有 Provider 的配置组件 */}
            </>
          )}
        ...
        {/* 移除了 RealtimeConfigList 实时聊天设置 */}
        {/* 移除了 TTSConfigList 文本转语音设置 */}
